...
#define EEP_STORAGE_ENABLED 1U
#define EEP_STORAGE_SIZE 2048
#define EEP_STORAGE_SIMPLEMODE 0
#define EEP_STORAGE_BLOCKINGMODE 1
#define EEP_STORAGE_WEARLEVELING_FACTOR 1
#define EEP_STORAGE_REDUNDANT_COPY 0
#define EEP_STORAGE_PHYSICAL_SIZE CY_EM_EEPROM_GET_PHYSICAL_SIZE(2048,0,1,0)
