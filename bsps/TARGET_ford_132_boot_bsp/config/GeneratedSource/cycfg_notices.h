...
#if !defined(CY8C4147AZS_S285)
#error "Unexpected MPN; expected DEVICE:=CY8C4147AZS-S285. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C4147AZS_S285) */
